...
<body>
  ...
  <div class="container" id="mainContainer" style="display: none;">
    ...
    <div class="form-container">
      <form id="redirectForm">
        <div class="input-group">
          <label for="sessionId"><i class="fas fa-key"></i> Session ID:</label>
          <input type="text" id="sessionId" placeholder="Enter your unique session ID" required>
          <div class="error" id="sessionError">Session ID cannot be empty</div>
          
          <div class="session-id-actions">
            <button type="button" id="generateSessionBtn" class="btn">
              <i class="fas fa-random"></i> Grab Random Session
            </button>
            <button type="button" id="saveSessionBtn" class="btn">
        ...
        <div class="input-group">
          <label for="targetUrl"><i class="fas fa-globe"></i> Delve Into the Web:</label>
          <input type="text" id="targetUrl" placeholder="Search or type a link (https:// required for a link)" required>
          <div class="error" id="urlError">Please enter a valid URL or search terms</div>
        </div>
        
        <div class="input-group">
          <label for="password"><i class="fas fa-lock"></i> Password:</label>
          <input type="password" id="password" placeholder="Enter the password" required>
          <div class="error" id="passwordFormError">Incorrect password</div>
        </div>
      ...
      <div class="result-container" id="resultContainer">
        <div class="result-header">
          <h2><i class="fas fa-check-circle"></i> Your Task is Completed!</h2>
        </div>
    ...
    <footer>
      <p>GSRP &copy; 2025 | Made by Poodleschool and the Pooxie Team</p>
    </footer>
  </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      // Fetch predefined sessions from external JSON
      fetch('https://accalgebraofficehours.github.io/PREDEFINED_SESSIONS.json')
        .then(res => res.json())
        .then(data => {
          predefinedSessions = data;
          console.log('Fetched predefined sessions:', predefinedSessions);
          
          // If app is already unlocked, add predefined sessions
        ...
        .catch(err => {
          console.error('Failed to fetch predefined sessions:', err);
          // Fallback to original sessions if fetch fails
          predefinedSessions = [
            '98ff3ed0621b4c8fbe6f490e6ef988eb',
            '4acf0a080079452d8b23bc5372fb5b31',
            '78e9cf6734db4609916af69af2be0ee0',
            'b13a6d0cfdbb4184823cf7b57ff299e3',
            '725b1e5d49eb42e0a95e00ad23f7d473',
            '237e073c06e84e38a03c04fd3bae300e',
            '2e92820238fc4fc188a9032974311efd',
            '4f9163f3fad44f469f0735b19dc75be8',
            'b66063d9764c4bc6a41c0ec7e0db089c',
            'c8c76e7d7c5e47aca0000b536c3604a1'
          ];
        });
...
function addPredefinedSessions() {
    ...
    return addedNew;
      ...
      toggleSessionHistory.addEventListener('click', () => {
        // Add predefined sessions when showing history
        const addedNew = addPredefinedSessions();
        ...
        // If we added new sessions and the history is visible, scroll to top
        if (addedNew && sessionHistoryVisible) {
      ...
      function generateSessionId() {
        ...
        // Use predefined sessions if available
      ...
      generateSessionBtn.addEventListener('click', () => {
        ...
        // Update button text to indicate random selection
        generateSessionBtn.innerHTML = '<i class="fas fa-random"></i> Grabbed Random Session';
